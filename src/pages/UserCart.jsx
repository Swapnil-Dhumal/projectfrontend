...
const UserCart = () => {
    ...
    const handleCheckout = async (product) => {
        try {
            await axios.put(`https://backend-pam6.vercel.app/api/data/products/${product._id}`, {
                cust_id: "",
                cust_name: "",
                booked: false,
    ...
    const handleCommonCheckout = async () => {
        ...
        try {
            await axios.post("https://backend-pam6.vercel.app/api/data/usercart", { updatedProducts });
