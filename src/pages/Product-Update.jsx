...
const ProductUpdate = () => {
    ...
    const getSingleProductData = async () => {
        try {
            const response = await fetch(`https://backend-pam6.vercel.app/api/admin/products/${params.id}`, {
                method: "GET",
                headers: {
    ...
    const handleSubmit = async(e) => {
        e.preventDefault();
        try {
            const response = await fetch(`https://backend-pam6.vercel.app/api/admin/products/update/${params.id}`, {
                method: "PATCH",
                headers: {
