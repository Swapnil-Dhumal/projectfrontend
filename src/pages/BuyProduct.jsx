...
const BuyProduct = () => {
    ...
    useEffect(() => {
        const getSingleProductData = async () => {
            try {
                const response = await fetch(`https://backend-pam6.vercel.app/api/auth/bookproduct/${params.id}`, {
                    method: "GET",
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`https://backend-pam6.vercel.app/api/auth/bookproduct/update/${params.id}`, {
                method: "PATCH",
                headers: {
